...
Katalon Studio link:https://docs.katalon.com/katalon-studio/release-notes/katalon-studio-release-notes-version-10.x#version-1020[v10.2.0] introduced a new test suite HTML report template, which does not show the Test Step descriptions at all. The original poster of the topic in the Katalon Community link:https://forum.katalon.com/t/how-to-display-steps-description-into-new-html-report/173818/15[argued] insisted that this is serious for him and requested a fix A.S.A.P.
